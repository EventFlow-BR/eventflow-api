...
class RegistrationCancelledAfterCommitIntegrationTest
    ...
    @Test
    void shouldPublishRegistrationCancelledMessageAfterCancellationCommit() {
        ...
        User organizer = new User(
                "Cancellation Messaging Organizer",
                "cancel-msg-organizer-" + suffix + "@example.com",
                "encoded-password",
                UserRole.ORGANIZER
        );

        User participant = new User(
                "Cancellation Messaging Participant",
                "cancel-msg-participant-" + suffix + "@example.com",
                "encoded-password",
        ...
        Event event = new Event(
                organizer,
                "Cancellation Messaging Event",
                "Cancellation messaging integration test",
                "Petrópolis",
